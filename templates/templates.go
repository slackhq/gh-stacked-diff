...
func ResolveCommitIndicator(commitIndicator string, indicatorType IndicatorType) GitLog {
	...
	case IndicatorTypePr:
		...
		branchName := util.ExecuteOrDieTrimmed(util.ExecuteOptions{}, "gh", "pr", "view", commitIndicator, "--json", "headRefName", "-q", ".headRefName")
		...
		prCommit := util.ExecuteOrDieTrimmed(util.ExecuteOptions{}, "gh", "pr", "view", commitIndicator, "--json", "commits", "-q", "[.commits[].oid] | first")
